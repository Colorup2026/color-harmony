  ...
  return (
    <section className="py-20 md:py-28 bg-gradient-hero relative overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute bottom-0 left-1/4 w-72 h-72 rounded-full bg-warm-peach/20 blur-3xl" />
        <div className="absolute top-0 right-1/4 w-64 h-64 rounded-full bg-warm-nude/20 blur-3xl" />
      </div>
